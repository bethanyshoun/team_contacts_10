  ...
  return `
    <div class="card employee-card">
        ...
        <div class="card-body">
            ...
            <p class="github">GitHub Username: <a href="https://github.com/${engineer.github}"></a>${engineer.github}</p>
        </div>
    </div>
  `;
}
...
const generateTeamPage = function (employeeCards) {
  ...
  <head>
      ...
      <title>Team Contacts Profile</title>
